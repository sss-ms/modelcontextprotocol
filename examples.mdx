...
本页面展示了各种 Model Context Protocol (MCP) 服务器，展示了协议的功能和多样性。这些服务器使大型语言模型（LLM）能够安全地访问工具和数据源。
...
- **[Obsidian Markdown Notes](https://github.com/calclavia/mcp-obsidian)** - 读取和搜索 Obsidian 库中的 Markdown 笔记
...
- **[Search1API](https://github.com/fatwang2/search1api-mcp)** - 搜索、爬虫和网站地图的统一 API
...
- **[Kubernetes](https://github.com/Flux159/mcp-server-kubernetes)** - 管理 pods、部署和服务
...
> **注意：** 社区服务器未经测试，使用风险自负。它们与 Anthropic 没有关联，也未得到其认可。

完整的社区服务器列表，请访问 [MCP Servers Repository](https://github.com/modelcontextprotocol/servers)。
...
要在 Claude 中使用 MCP 服务器，将其添加到您的配置中：
...
- [Awesome MCP Servers](https://github.com/punkpeye/awesome-mcp-servers) - MCP 服务器精选列表
